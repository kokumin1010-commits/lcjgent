  ...
  const topCommercers = [
    {
      ...
      statValue: '',
      statUnit: '',
      image: '/lcf-top-kyogoku-user-original-ff6e0c92.webp',
    ...
    },
    {
      ...
      statValue: '',
      statUnit: '',
      image: '/lcf-top-prince-koya-user-original-9d87ff7d.jpg',
    ...
    },
    {
      ...
      statValue: '',
      statUnit: '',
      image: '/lcf-top-kumada-kana-user-original-8006cddc.jpg',
...
function SpecialLiversSection() {
  ...
  const livers = [
    ...
    {
      name: 'toki',
      photo: '/lcf-toki-408d94ebddc4.jpg',
      title: 'ライブコマーサー',
    ...
    {
      name: '王明陽（おうめいよう）',
      photo: '/lcf-ou-meiyou-ead469484082.png',
      title: 'ライブコマーサー',
    ...
    {
      name: 'ライコマチャンネル',
      photo: '/lcf-licoma-channel-0b8deaf9f4cd.png',
      title: 'ライブコマーサー',
    ...
    {
      name: 'きゃべつ',
      photo: '/lcf-kyabetsu-0404ec5633a7.png',
      title: 'ライバー',
    ...
    {
      name: 'ナルド一家',
      photo: '/lcf-narudo-ikka-be31321bdae2.png',
      title: 'ライブコマーサー',
    ...
    {
      name: 'HONMAMON',
      photo: '/lcf-honmamon-c716894a0bf0.png',
      title: 'ライブコマーサー',
      ...
      <div ref={reveal.ref} className={`max-w-5xl mx-auto transition-all duration-700 ${reveal.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5 mb-10">
          ...
          <div className="p-6 rounded-xl border border-white/10 bg-white/[0.02]">
            ...
            <ul className="text-sm text-gray-300 space-y-2">
              <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-gray-500 mt-0.5 shrink-0" /> 標準ブース（3m×2m）</li>
