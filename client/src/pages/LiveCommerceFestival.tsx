...
function SpecialLiversSection() {
  ...
  const livers = [
    ...
    {
      name: '王明陽（おうめいよう）',
      photo: '/lcf-ou-meiyou-5114be626d20.jpg',
      title: 'ライブコマーサー',
    ...
    {
      name: 'ライコマチャンネル',
      photo: '/lcf-licoma-channel-144c85df0cc4.jpg',
      title: 'ライブコマーサー',
    ...
    {
      name: 'きゃべつ',
      photo: '/lcf-kyabetsu-1324f12dfb84.jpg',
      title: 'ライバー',
    ...
    {
      name: 'ナルド一家',
      photo: '/lcf-narudo-ikka-3b4598fc9a63.jpg',
      title: 'ライブコマーサー',
    ...
    {
      name: 'HONMAMON',
      photo: '/lcf-honmamon-386730d5080b.jpg',
      title: 'ライブコマーサー',
