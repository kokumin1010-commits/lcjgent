...
import { LayoutDashboard, LogOut, PanelLeft, Users, ClipboardList, Settings, FileText, UserCog, Globe, Brain, Building2, CreditCard, MessageSquare, Bell, AlertCircle, Calendar, Video, MessageCircle, Package, ShoppingCart, UserCheck, Zap, Wallet, Calculator, UserRoundCog, Megaphone, Store, GraduationCap } from "lucide-react";
...
function DashboardLayoutContent({
  ...
  const menuItems = [
    ...
    { icon: GraduationCap, label: "AI学習ダッシュボード", path: "/master/ai-learning" },
