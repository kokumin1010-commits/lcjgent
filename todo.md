...
- [ ] 中国已付人工费卡片可点击并展开29笔中信银行实际支出
- [ ] 日本已付人工费卡片可点击并展开108笔MITSUI/RESONA实际支出
- [ ] 钻取明细逐笔显示日期、员工或摘要、金额、币种和银行账户
- [ ] 中国与日本明细严格按CNY/JPY和权威账户分开，不混合工资表生成支出
- [ ] 可在中国、日本两组明细间切换，并可再次点击收起
- [ ] 补充银行实际人工费明细接口和点击状态测试
