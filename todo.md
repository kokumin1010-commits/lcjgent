...
## 独立給与明細入口（2026-08-27）
- [ ] 在顶部操作区“給与表取込”左侧增加“給与明細”按钮
- [ ] “給与表取込”继续只负责上传，按钮位置和原流程保持不变
- [ ] 点击“給与明細”后在当前页面展开独立工资明细面板，不创建新页面
- [ ] 独立面板默认同时显示日本和中国工资，JPY与CNY分开汇总
- [ ] 提供国家、工资月、员工姓名筛选及明显的“全部员工/清除筛选”入口
- [ ] 员工行继续显示实发金额、现金流金额和已付款/支出已生成状态
- [ ] 测试顶部按钮位置、展开关闭、中日联合数据和筛选恢复
- [ ] 发布后在生产页面核对交互与金额
