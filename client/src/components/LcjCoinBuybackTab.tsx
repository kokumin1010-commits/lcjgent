          ...
          <div className="space-y-3">
            {periods.map((period: any) => (
              <div key={period.id} className="p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-colors">
                ...
                <div className="flex gap-6 text-xs text-white/80 mt-1">
      ...
      <Dialog open={createDialog} onOpenChange={setCreateDialog}>
        <DialogContent className="bg-[#0a0a0f] border-white/10 text-white max-w-lg">
          ...
          <div className="space-y-4">
            <div>
              <Label className="text-white/90">期間名</Label>
              <Input
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label className="text-white/90">開始日</Label>
                <Input
                  type="date"
                  className="bg-white/5 border-white/10 text-white"
              ...
              <div>
                <Label className="text-white/90">終了日</Label>
                <Input
                  type="date"
                  className="bg-white/5 border-white/10 text-white"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label className="text-white/90">上限（確定済みの%）</Label>
                <Input
                  type="number"
                  className="bg-white/5 border-white/10 text-white"
              ...
              <div>
                <Label className="text-white/90">1コイン価格（円）</Label>
                <Input
                  type="number"
                  step="0.01"
                  className="bg-white/5 border-white/10 text-white"
            ...
            <div>
              <Label className="text-white/90">予算上限（円・任意）</Label>
              <Input
                type="number"
                className="bg-white/5 border-white/10 text-white"
            ...
            <div>
              <Label className="text-white/90">備考</Label>
              <Textarea
                className="bg-white/5 border-white/10 text-white"
