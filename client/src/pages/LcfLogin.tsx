    ...
    <div className="min-h-screen bg-[#0a0a0f] px-4 py-10 text-white flex items-center justify-center">
      <div className="w-full max-w-lg">
        ...
        {showForgot && (
          ...
          <div><label className="mb-1 block text-sm text-gray-400">パスワード</label><input type="password" value={registerPassword} onChange={(e) => setRegisterPassword(e.target.value)} className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-gray-500 outline-none transition-colors focus:border-amber-500/50" placeholder="英字と数字を含む12文字以上" minLength={12} maxLength={128} required /><p className="mt-1.5 text-[11px] leading-5 text-gray-500">英字と数字をそれぞれ1文字以上含めてください。</p></div>
