...
- [ ] 将“恢复财务证据 / 财务复旧证迹”区域改为可折叠
- [ ] 默认收起，仅保留标题、说明、证据快照件数和展开按钮
- [ ] 展开后保持现有三张摘要卡、明细表和警告说明不变
- [ ] 补充可访问性属性并验证键盘与点击操作
- [ ] 运行前端打包检查并发布到生产
- [ ] 在生产入出金管理页面验证默认收起、展开和再次收起

## 工资照合逐人明细与中日人工费（2026-08-27）
- [ ] 将“工资表照合”卡片改为可点击展开和再次收起
- [ ] 展开后按法人、工资月和员工显示逐人工资金额
- [ ] 逐人显示已付款/已生成支出状态及对应现金流金额
- [ ] 在工资照合区域明确显示中国已付人工费（CNY）与日本已付人工费（JPY）
- [ ] 保留现有法人、工资月和员工筛选联动
- [ ] 补充逐人明细和付款状态测试
...
- [ ] 发布后在生产环境验证新增、上传、查看和删除完整流程
- [ ] 修复生产旧表继续缺少 `startDate` 等字段的问题，迁移必须覆盖请求书读写所需全部字段
- [ ] 扩展迁移测试，验证多列缺失时一次补齐且旧数据保留
