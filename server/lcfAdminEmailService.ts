...
function buildLcfHtml(body: string): string {
  const paragraphs = escapeHtml(body)
    ...
    .join("");
  return `<!doctype html><html lang="ja"><head><meta charset="utf-8"></head><body style="margin:0;background:#f3f4f6;color:#171717;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Hiragino Kaku Gothic ProN','Yu Gothic',Meiryo,sans-serif"><div style="max-width:680px;margin:0 auto;padding:32px 16px"><div style="overflow:hidden;border:1px solid #e5e7eb;border-radius:16px;background:#ffffff;box-shadow:0 12px 36px rgba(0,0,0,.08)"><div style="background:#09090b;padding:24px 28px;border-bottom:6px solid #facc15"><div style="font-size:22px;line-height:1.25;font-weight:800;letter-spacing:.02em;color:#facc15">LIVE COMMERCE FESTIVAL</div><div style="margin-top:7px;font-size:12px;line-height:1.6;letter-spacing:.08em;color:#d4d4d8">企業・ブランド・ライブコマーサーがつながる公式イベント</div></div><div style="padding:28px 28px 20px">${paragraphs}</div><div style="border-top:1px solid #f0f0f0;padding:16px 28px;background:#fafafa;font-size:11px;line-height:1.7;color:#71717a">本メールは LIVE COMMERCE FESTIVAL 運営事務局からお送りしています。<br><a href="https://www.livecommercefestival.com/" style="color:#a16207;text-decoration:none">livecommercefestival.com</a></div></div></div></body></html>`;
}
