...
const SetImageGenerator = lazy(() => import("./pages/SetImageGenerator"));
...
const LcfLogin = lazy(() => import("./pages/LcfLogin"));
...
const LcfGuidance = lazy(() => import("./pages/LcfGuidance"));
const LcfGuidanceIndex = lazy(() => import("./pages/LcfGuidanceIndex"));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/lcf/login" component={LcfLogin} />
        ...
        <Route path="/lcf/guidance/2026" component={LcfGuidance} />
        <Route path="/lcf/guidance" component={LcfGuidanceIndex} />
        ...
        <Route path="/master/set-image-generator">
          <DashboardLayout>
            <SetImageGenerator />
          </DashboardLayout>
        </Route>
