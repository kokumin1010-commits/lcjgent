...
checks = {
    ...
    "upgrade_pre_backup": 'PRE_BACKUP_REASON = "pre-staff-identity-consistency-v1"' in upgrade,
    "upgrade_post_backup": 'POST_BACKUP_REASON = "post-staff-identity-consistency-v1"' in upgrade,
    "upgrade_unique_identity": "staff_identity_key_unique" in upgrade and "ADD UNIQUE KEY staff_identity_key_unique" in upgrade,
    "upgrade_unique_report_link": "report_staff_linked_staff_unique" in upgrade and "ADD UNIQUE KEY report_staff_linked_staff_unique" in upgrade,
    ...
    "backup_required_for_merge": "verified backup is required before identity merge" in identity,
